...
const T = {
  ...
  accent:"#FF2D6F",text:"#1A1D23",sub:"#5A6070",dim:"#7B8494",
...
const SEED_PAT=[
  ...
  mk("2026-02-16","quad","Quad Day","quad",[["BB Back Squat (Ramping)",["Barbell Back Squat",1,8,135],["Barbell Back Squat",1,6,185],["Barbell Back Squat",2,6,205],["Barbell Back Squat",1,10,165]],["Core – 3 rds",["Hip Flexors",3,8,null],["Box Crunches",3,10,null]],["Superset – 4 rds",["Single Leg Extension",4,8,55],["Box Step Overs",4,10,null]],["Conditioning – 4 rds",["Bike",4,1,null,".7 mi"],["Banded Abductors",4,10,null],["Calf Raises",4,12,null]]]),
  mk("2026-02-24","quad","Quad Day","quad",[["BB Back Squat (Volume)",["Barbell Back Squat",5,10,135]],["Superset – 4 rds",["Leg Extension",4,10,90],["Jump Squats",4,10,null]],["Trap Bar DL",["Trap Bar Deadlift",4,10,185]],["Superset – 4 rds",["Hamstring Curl",4,10,90],["Front Lunges",4,20,null]]]),
];
...
const SEED_KERIE=[
  mk("2025-10-03","full","Full Body","3 min bike, PVC, leg band warm up",[["Circuit – 3-4 rds",["Incline Push Up",4,10,null],["KB Squat to High Pull",4,10,15],["Bench Dips",4,8,null]],["Core – 3-4 rds",["Weighted Dead Bug",4,10,10],["Russian Twist",4,20,null]],["Circuit – 3-4 rds",["DB Bicep Curl",4,8,10],["KB Sumo Squat",4,8,25],["Farmer's Carry",4,2,25]],["Finisher – 3 rds",["Bike",3,1,null],["Med Ball Slams",3,10,15]]]),
  mk("2025-10-10","full","Full Body","Bike 3 min, class warm up",[["Circuit – 4 rds",["DB Push Press",4,8,null],["KB Goblet Squat",4,8,null],["Plate Front Raise",4,8,null]],["Core – 3 rds",["Plate Halo",3,10,null],["Side Crunch",3,10,null]],["Circuit – 4 rds",["Hammer Curl",4,10,null],["Split Lunge",4,8,null],["Cable Tricep Push Down",4,10,null]],["Finisher – 4 rds",["Ski",4,10,null],["KB High Pull",4,10,null]]]),
  mk("2025-10-17","full","Full Body","Bike 3 min, class warm up",[["Glute Activation – 3 rds",["Banded Glute Bridge",3,10,null],["Abductor Pulse",3,15,null]],["Circuit – 4 rds",["KB Curl to Press",4,8,25],["Leg Extension",4,10,null],["Cable Diagonal Tricep",4,10,null]],["Circuit – 4 rds",["DB Crush Grip Press",4,8,null],["Cable Row",4,10,null],["Leg Curl",4,8,null]],["Finisher – 4 rds",["Row",4,1,null,"150m"],["KB Squat to High Pull",4,10,null]]]),
  mk("2025-10-24","full","Full Body","3 min bike, PVC, leg band warm up",[["Circuit – 4 rds",["Cable Row",4,10,null],["Goblet Squat",4,10,25],["Barbell Incline Push Up",4,10,null]],["Circuit – 4 rds",["DB Zottman Curl",4,8,12],["DB Lunge Pulse",4,10,10],["Cable Tricep Push Down",4,10,null]],["Core – 4 rds",["DB Weighted Dead Bug",4,20,8],["Heel Taps",4,20,null]],["Finisher – 3-4 rds",["Row",4,1,null,"1 min"],["KB High Pull",4,8,25],["KB Bicep Curl",4,8,25]]]),
  mk("2025-11-21","full","Full Body","3 min bike, PVC, leg band warm up",[["Circuit – 3-4 rds",["Incline Push Up",4,10,null],["KB Squat to High Pull",4,10,15],["Bench Dips",4,8,null]],["Core – 3-4 rds",["Weighted Dead Bug",4,10,10],["Russian Twist",4,20,null]],["Circuit – 3-4 rds",["DB Bicep Curl",4,8,10],["KB Sumo Squat",4,8,25],["Farmer's Carry",4,2,25]],["Finisher – 3 rds",["Bike",3,1,null],["Med Ball Slams",3,10,15]]]),
  mk("2025-12-05","full","Full Body","Bike 3 min, PVC, leg band warm up",[["Circuit – 4 rds",["Plate Overhead Press",4,10,35],["KB Goblet Squat",4,10,25],["Plate Front Raise",4,10,15]],["Circuit – 4 rds",["7-7-7 Curls",4,21,12],["Leg Extension",4,10,55],["S/A Row",4,10,30]],["Circuit – 4 rds",["Incline Push Up",4,10,10],["Leg Curl",4,10,55],["DB Side Crunch",4,10,null]],["Finisher – 3 rds",["Row",3,1,null,"200m"],["Farmer's Carry",3,1,25],["KB Calf Raise",3,10,25]]]),
  mk("2025-12-08","full","Full Body","3 min bike, band upper + lower warm up",[["Circuit – 4 rds",["Hammer Curl",4,10,12],["Leg Extension",4,10,45],["Cable Row",4,10,45]],["Circuit – 3 rds",["Leg Curl",3,10,45],["Cable Tricep Push Down",3,10,35],["Split Squat Lunge",3,10,null]],["Core – 3 rds",["Alt Bird Dog",3,10,null],["Russian Twist",3,20,10]]]),
  mk("2025-12-12","upper","Full Upper","3 min bike, PVC",[["Circuit – 4 rds",["7-7-7 Curls",4,21,10],["S/A Row",4,10,25],["Band Tricep Kickback",4,10,null]],["Core – 3 rds",["Plate Halo",3,10,10],["Plate Overhead March",3,20,null],["KB Side Crunch",3,10,15]],["Circuit – 4 rds",["Crush Grip Press",4,10,10],["Cable Row",4,10,null],["Around the World",4,10,8]],["Finisher – 3 rds",["Ski",3,10,null],["KB High Pull",3,10,15]]]),
  mk("2025-12-22","full","Full Body","3 min bike, PVC, leg band warm up",[["Circuit – 4 rds",["Incline Push Up",4,10,null],["KB Sumo Squat",4,10,35],["KB High Pull",4,10,25]],["Core – 3 rds",["Weighted Dead Bug",3,10,5],["Russian Twist",3,20,15]],["Circuit – 4 rds",["ISO Hammer Curl",4,8,15],["Leg Extension",4,10,55],["Farmer's Carry",4,2,null]],["Finisher – 3 rds",["Bike Arms Only",3,1,null],["Leg Curl",3,10,55]]]),
  mk("2025-12-29","full","Full Body","Bike 3 min, PVC, leg band warm up",[["Circuit – 4 rds",["Plate Overhead Press",4,10,25],["Banded Sissy Squat",4,10,null],["Barbell Row",4,10,null]],["Circuit – 4 rds",["Curl Bar",4,10,25],["Leg Extension",4,10,60],["Tricep Cable Extension",4,10,30]],["Circuit – 4 rds",["Incline Push Up",4,10,null],["Leg Curl",4,10,55],["DB Side Crunch",4,10,null]],["Core + Finisher",["Banded Glute Bridge w/ Lat Pullover",3,10,null],["Band Adductor Pulse",3,20,null],["Row",3,1,null,"200m"],["Farmer's Carry",3,1,25],["KB Calf Raise",3,10,25]]]),
  mk("2026-01-02","upper","Full Upper","3 min bike, PVC",[["Circuit – 4 rds",["DB Curl",4,10,12],["Barbell Row",4,10,null],["Band Tricep Kickback",4,10,null]],["Core – 3 rds",["Plate Halo Hip to Hip",3,10,10],["Plate Overhead March",3,20,null]],["Circuit – 4 rds",["Crush Grip Press",4,10,10],["Cable Row",4,10,null],["Around the World",4,10,8]],["Finisher – 3 rds",["Ski",3,10,null],["KB High Pull",3,10,15]]]),
  mk("2026-01-05","full","Full Body","Row 3 min, PVC, leg band warm up",[["Circuit – 4 rds",["Bench Press",4,10,45],["Goblet Squat",4,10,35],["Cable Crunch",4,10,null]],["Circuit – 4 rds",["Hammer Curl",4,10,12],["Leg Extension",4,10,55],["S/A Row",4,10,30]],["Circuit – 4 rds",["Leg Curl",4,10,55],["Med Ball Slams",4,10,20],["S/A Cable Diagonal Tricep",4,10,null]],["Finisher",["Ski",1,12,null,"12 cal"],["Sumo Squat Pulse",1,15,35]]]),
  mk("2026-01-09","upper","Upper","Bike warm up, PVC",[["Circuit – 4 rds",["DB ISO Bicep Curl",4,8,null],["S/A Banded Lat Pull Down",4,8,null],["DB Tricep Extension",4,8,null]],["Core – 3 rds",["Ab Rollout",3,10,null],["Flutter Kicks",3,10,null]],["Circuit – 4 rds",["Barbell Bent Over Row",4,8,null],["Cable Row Machine",4,8,null],["Knee Push Up",4,8,null]],["AMRAP",["Bike",1,1,null,"1 min"],["KB Curl",1,10,25],["KB Press",1,10,15]]]),
  mk("2026-01-12","full","Full Body","Bike 3 min, PVC, leg band warm up",[["Circuit – 4 rds",["Plate Overhead Press",4,10,25],["Sumo Squat",4,10,35],["Gorilla Row",4,10,25]],["Circuit – 4 rds",["Curl Bar",4,10,25],["Leg Extension",4,10,60],["Cable Diagonal Extension",4,10,30]],["Circuit – 4 rds",["Incline Push Up",4,10,null],["Leg Curl",4,10,60],["DB Side Crunch",4,10,null]],["Core + Finisher",["Banded Glute Bridge w/ Lat Pullover",3,10,15],["Band Adductor Pulse",3,20,null],["Row",3,1,null,"200m"],["Farmer's Carry",3,1,25],["KB Calf Raise",3,10,25]]]),
  mk("2026-02-13","full","Full Body","Bike 3 min, PVC, leg band warm up",[["Circuit – 4 rds",["DB Push Press",4,8,10],["Sumo Squat",4,10,35],["S/A Row",4,10,20]],["Circuit – 4 rds",["DB Hammer Curl",4,10,12],["Leg Extension",4,10,60],["S/A Tricep Extension",4,10,20]],["Circuit – 4 rds",["Incline Push Up",4,10,null],["Leg Curl",4,10,60],["DB Side Crunch",4,10,null]],["Core + Finisher",["Banded Glute Bridge",3,10,null],["Banded Glute March",3,10,null],["Band Adductor Pulse",3,20,null],["Bike",3,1,null],["Farmer's Carry",3,1,25],["KB Calf Raise",3,10,25]]]),
  mk("2026-02-16","full","Full Body","3 min bike, band upper + lower warm up",[["Circuit – 4 rds",["7-7-7 Curls",4,21,12],["Leg Curl",4,10,45],["Cable Row",4,10,45]],["Circuit – 3 rds",["Seated Push Press",3,10,10],["Leg Extension",3,10,45],["Cable Tricep Push Down",3,10,35]],["Core – 3 rds",["Dead Bug",3,10,5],["Heel Taps",3,20,null]],["Finisher",["Walk or Row",1,1,null],["KB High Pull",1,8,null],["Split Squat Pulse",1,10,null]]]),
];

const SEED_CLIENT_KERIE={id:"kerie",name:"Kerie",fullName:"Kerie",startDate:"2025-10-03",color:"#F59E0B",
...
const SEED_BILLY=[
  mk("2025-01-13","full","Full Body","3 min bike, class warm up",[["Circuit – 3 rds",["Push Up",3,10,null],["DB Bicep Curl",3,10,25,"A:10-15"],["KB Goblet Squat",3,10,35,"A:26"]],["Circuit – 3 rds",["DB Front Raise",3,10,10,"A:5-10"],["Walking Lunges",3,10,null,"BW"],["Plank KB Pull Through",3,10,26,"A:18"]],["Finisher – 3 rds",["Bike",3,12,null,"12 cal"],["DB RDL",3,8,25,"A:15"],["DB Push Press",3,10,15,"A:10"]]]),
  mk("2025-01-20","full","Full Body","3 min bike, class warm up",[["Circuit – 3 rds",["Incline Push Up",3,10,null],["Butterfly Situp",3,10,null],["KB Squat to High Pull",3,10,26,"A:18"]],["Circuit – 3 rds",["KB Bicep Curl",3,10,26,"A:18"],["KB Goblet Squat",3,10,35,"A:26"],["Plank Hold",3,20,null,"sec"]],["Finisher – 3 rds",["Row",3,1,null,"200m"],["Med Ball Slams",3,10,20,"A:10"]]]),
  mk("2025-01-27","full","Full Body","3 min bike, class warm up",[["Circuit – 4 rds",["Butterfly Situp",4,12,null],["KB Goblet Squat",4,10,44,"A:26"],["DB Bicep Curl",4,10,25,"A:8"]],["Circuit – 4 rds",["DB Front Raise",4,10,10,"A:5"],["Walking Lunges",4,10,20,"A:BW/5"],["DB Side Raise",4,10,10,"A:5"]],["Circuit – 4 rds",["Bike",4,12,null,"12 cal"],["DB RDL",4,8,25,"A:15"],["DB Incline Bench Press",4,10,20,"A:10"]],["Finisher – 3 rds",["Plank Hold",3,40,null,"sec"]]]),
  mk("2025-02-03","full","Full Body","3 min bike, class warm up",[["Circuit – 4 rds",["Incline Push Up",4,10,null],["Leg Raise",4,10,null],["KB Squat to Clean",4,10,35,"A:26, A did BW squats"]],["Circuit – 4 rds",["KB Bicep Curl",4,10,35,"A:26"],["KB Sumo Squat Pulse",4,20,null,"A:26"],["Plank Shoulder Taps",4,20,null]],["Finisher – 3 rds",["Row",3,1,null,"300m"],["Med Ball Slams",3,10,20,"A:15"]]]),
  mk("2025-02-10","full","Full Body","3 min bike, class warm up",[["Core – 4 rds",["Weighted Dead Bug",4,20,null],["Situp",4,10,null,"B:med ball, A:band assisted"]],["Circuit – 4 rds",["Step Up",4,10,20,"A:5"],["DB Around the World",4,10,10,"A:5"],["DB RDL",4,10,25,"A:15"]],["Circuit – 4 rds",["DB Zottman Curl",4,10,25,"A:8"],["KB Sumo Squat",4,10,null,"A:18"],["Bench Dip",4,10,null]],["Circuit – 4 rds",["Row",4,12,null,"12 cal"],["Lunge Pulse",4,15,20,"A:BW/5"]],["Finisher – 3 rds",["Plank Hold",3,40,null,"sec"]]]),
  mk("2025-02-17","full","Full Body","3 min bike, class warm up",[["Core – 4 rds",["Weighted Dead Bug",4,20,30,"A:15"],["Situp",4,10,30,"A:band assisted"]],["Circuit – 4 rds",["DB Goblet Squat",4,10,40,"A:20"],["DB Halo",4,10,25,"A:15"],["Barbell RDL",4,10,null,"A:bar, B:15s"]],["Circuit – 4 rds",["KB Suitcase Deadlift",4,8,53,"A:26"],["KB Farmer's Carry",4,2,53,"A:26"],["KB Calf Raise",4,10,53,"A:26/18"]],["Circuit – 4 rds",["Ski",4,12,null,"10/12 cal"],["KB Curl & Press",4,10,53,"A:26"],["Lunge Pulse",4,15,null]]]),
  mk("2025-02-24","full","Full Body","3 min bike, class warm up",[["Core – 4 rds",["Situp",4,10,20,"A:BW"],["Russian Twist",4,20,20,"A:15"]],["Circuit – 4 rds",["Hammer Curl",4,10,25,"A:10"],["DB Goblet Squat",4,10,40,"A:20"],["DB Around the World",4,10,10,"A:5"]],["Circuit – 4 rds",["DB Seated Push Press",4,10,25,"A:10"],["Walking Lunges",4,10,20,"A:BW"],["Banded Tricep Pushdown",4,10,null]],["Finisher – 2 rds",["Bike Arms Only",2,1,null],["Bike Legs Only",2,1,null]]]),
  mk("2025-03-03","full","Full Body","3 min bike, class warm up",[["Core – 4 rds",["Weighted Situp",4,10,null],["Flutter Kicks",4,25,null]],["Trap Bar DL – 4 rds",["Trap Bar Deadlift Row",4,8,null,"A:5s, B:25s"]],["Circuit – 4 rds",["DB Alt Curl w/ Hold",4,10,20,"A:10"],["Step Up",4,10,20,"A:8"],["Bench Dip",4,15,null]],["Circuit – 4 rds",["DB Goblet Squat",4,10,40,"A:20"],["DB Incline Crush Grip Press",4,10,25,"A:10"],["DB Incline Chest Fly",4,10,25,"A:10"]],["Finisher – 3 rds",["Ski",3,12,null],["KB High Pull",3,10,35,"A:18"]]]),
  mk("2025-03-10","full","Full Body","3 min bike, class warm up",[["Core – 4 rds",["DB Halo w/ Twist",4,10,25,"A:12"],["DB S/A Press March",4,10,25,"A:12"]],["Circuit – 4 rds",["Walking Lunges",4,10,null,"A:BW, B:sandbag"],["Front Raise",4,10,10,"A:5"],["Barbell RDL",4,10,null,"A:bar, B:20s"]],["Circuit – 4 rds",["DB Zottman Curl",4,10,20,"A:8"],["KB Sumo Squat",4,10,null],["Banded Tricep Pushdown",4,12,null]],["Finisher – 4 rds",["Row",4,12,null,"12 cal"],["Med Ball Press Jack",4,10,null]]]),
  mk("2025-03-17","full","Full Body","3 min bike, class warm up",[["Core – 4 rds",["Ab Rollout",4,10,null],["Russian Twist",4,20,20,"A:15"]],["Circuit – 4 rds",["ISO Hammer Curl",4,8,25,"A:12"],["Push Sled",4,1,null,"A:1-45, B:3-45"],["KB Gorilla Row",4,8,null,"A:26, B:brown"]],["Circuit – 4 rds",["DB Seated Push Press",4,8,25,"A:10"],["Push Sled",4,1,null,"A:45"],["Bench Dip",4,8,null]],["Finisher",["Bike Arms Only",3,1,null],["Bike Both",3,1,null],["Bike Legs Only",3,1,null]]]),
  mk("2025-03-24","full","Full Body","3 min bike, class warm up",[["Core – 4 rds",["Weighted Situp",4,10,null],["Flutter Kicks",4,25,null]],["Circuit – 4 rds",["Trap Bar Deadlift",4,8,null,"A:5s, B:25s"],["KB Farmer's Carry",4,2,53,"A:35"]],["Circuit – 4 rds",["DB 5-5-5 Curl",4,15,25,"A:10"],["Step Up",4,10,25,"A:10"],["Banded Tricep Pushdown",4,15,null]],["Circuit – 4 rds",["DB Goblet Squat",4,10,40,"A:20"],["DB Incline Crush Grip Press",4,10,25,"A:10"],["DB Incline Chest Fly",4,10,25,"A:10"]],["Finisher – 3 rds",["Row",3,1,null,"200m"],["Med Ball Slams",3,10,30,"A:15"]]]),
  mk("2025-03-31","full","Full Body","3 min bike, class warm up",[["Core – 4 rds",["Halo & Twist",4,10,26,"A:18"],["S/A Press March",4,20,35,"A:26"]],["Circuit – 4 rds",["Incline Curl",4,10,25,"A:10"],["Sumo Squat",4,10,40,"A:20"],["DB Around the World",4,10,10,"A:5"]],["Circuit – 4 rds",["DB Seated Push Press",4,8,25,"A:10"],["Skull Crusher",4,8,null],["Deficit Reverse Lunge",4,8,20,"A:BW/5"]],["Finisher",["Bike Arms Only",3,1,null],["Bike Legs & Arms",3,1,null],["Bike Legs Only",3,1,null]]]),
  mk("2025-04-07","full","Full Body","3 min bike, class warm up",[["Core – 4 rds",["Dead Bug Crunch",4,10,null],["Russian Twist",4,20,null]],["Circuit – 4 rds",["Trap Bar Deadlift",4,8,null,"A:15s, B:35s"],["KB Farmer's Carry",4,2,53,"A:35"]],["Circuit – 4 rds",["DB 7-7-7 Curl",4,21,25,"A:10"],["Eccentric Step Down",4,10,null,"BW"],["Bench Dip",4,10,null]],["Circuit – 4 rds",["DB Palms Up Row",4,8,30,"A:20"],["DB Chest Press",4,10,30,"A:10"],["Incline Push Up",4,10,null]],["Finisher – 3 rds",["Row",3,1,null,"200m"],["Med Ball Slams",3,10,30,"A:15"]]]),
  mk("2025-04-10","full","Full Body","3 min bike, class warm up",[["Core – 4 rds",["S/A Press March",4,20,30,"A:20"],["Standing Side Crunch",4,10,30,"A:20"]],["Circuit – 4 rds",["ISO Hammer Curl",4,8,25,"A:12"],["Push Sled",4,1,null,"A:1-45, B:3-45"],["KB Gorilla Row",4,8,null,"A:26, B:brown"]],["Circuit – 4 rds",["DB Seated Push Press",4,8,25,"A:10"],["KB Goblet Squat",4,8,null,"A:26, B:brown"],["Banded OH Tricep Extension",4,8,null]],["Finisher – 3 rds",["Row",3,1,null,"150m"],["Med Ball Slams",3,10,null],["Plank Shoulder Taps",3,16,null]]]),
  mk("2025-04-14","full","Full Body","3 min bike, class warm up",[["Core – 3 rds",["Ab Rollout",3,10,null],["Russian Twist",3,20,null]],["Circuit – 4 rds",["Walking Lunges",4,10,null,"A:10s, B:40 sandbag"],["Plate Front Raise",4,10,25,"A:10"],["Barbell RDL",4,10,null,"A:10s, B:35s"]],["Circuit – 4 rds",["DB Zottman Curl",4,10,25,"A:10"],["KB Sumo Squat",4,10,70,"A:35"],["Banded Tricep Kickback",4,12,null]],["Finisher – 4 rds",["Row",4,12,null,"12 cal"],["Med Ball Press Jack",4,10,null]]]),
  mk("2025-04-21","full","Full Body","3 min bike, class warm up",[["Core – 4 rds",["Dead Bug Crunch",4,10,null],["Heel Taps",4,20,null]],["Circuit – 4 rds",["Trap Bar Deadlift",4,8,null,"A:15s, B:45s"],["KB Farmer's Carry",4,2,53,"A:35"]],["Circuit – 4 rds",["DB Incline Curl",4,8,25,"A:12"],["Bulgarian Split Squat",4,8,null,"BW"],["DB Incline Fly",4,8,25,"A:10"]],["Circuit – 4 rds",["Gorilla Row",4,8,null,"A:26, B:brown"],["Trap Bar RDL",4,8,null,"A:15s, B:65s"],["Push Up",4,10,null]],["Finisher – 3 rds",["Ski",3,12,null],["KB High Pull",3,10,null,"A:26, B:brown"]]]),
  mk("2025-04-28","full","Full Body","3 min bike, class warm up",[["Core – 3 rds",["Weighted Situp",3,10,null],["Russian Twist",3,20,null]],["Circuit – 4 rds",["ISO Hammer Curl",4,8,25,"A:12"],["Push Sled",4,1,null,"A:1-45, B:5-45"],["Barbell Bent Over Row",4,8,null,"A:10s, B:25s"]],["Circuit – 4 rds",["Around the World",4,8,15,"A:8"],["Step Up",4,8,30,"A:10"],["Bench Dip",4,8,null]],["Finisher – 3 rds",["Row",3,1,null,"150m"],["Med Ball Press Jack",3,10,30,"A:15"]]]),
  mk("2025-05-05","full","Full Body","3 min bike, class warm up",[["Circuit – 4 rds",["Incline Curl",4,10,25,"A:10"],["KB Sumo Squat",4,10,70,"A:35"],["Plate Raise",4,10,35,"A:15"]],["Bike + Legs – 3 rds",["Bike Arms Only",3,1,null],["Leg Extension",3,10,null]],["Bike + Back – 3 rds",["Bike Legs Only",3,1,null],["Cable Row",3,10,null]],["Circuit – 4 rds",["KB Clean & Press",4,10,null,"A:26, B:brown"],["Bench Dip",4,10,null],["Calf Raise",4,15,null]],["Core – 3 rds",["Plate Halo",3,10,25,"A:15"],["Plate Press March",3,20,35,"A:15"]]]),
  mk("2025-05-19","lower","Lower Body","3 min bike, banded side steps, banded monster, band squats",[["BB Back Squat",["Back Squat",1,8,95],["Back Squat",1,8,105],["Back Squat",1,8,115],["Back Squat",1,5,125],["Back Squat",1,5,135]],["Core – 3 rds",["Ab Rollout",3,10,null],["KB Side Crunch",3,10,35,"A:26"]],["Circuit – 3 rds",["Leg Extension",3,10,null,"A:45, B:2-45"],["KB Sumo Squat Pulse",3,20,null]],["Circuit – 3 rds",["Hamstring Curl",3,10,null,"A:45, B:2-45"],["Lunge Pulse",3,15,null]],["Finisher – 3 rds",["Bike",3,1,null,"1.5 min"],["KB Suitcase Deadlift",3,8,35],["KB Calf Raise",3,10,35]]]),
  mk("2025-05-27","lower","Lower Body","3 min bike, banded side steps, banded monster",[["BB Back Squat",["Back Squat",1,10,135],["Back Squat",4,8,145]],["Circuit – 4 rds",["Sled Push",4,1,null,"A:1-2 plate, B:4 plates"],["Butterfly Situp",4,10,null],["Calf Raise",4,10,53,"A:26"]],["Circuit – 4 rds",["Leg Extension",4,8,null,"A:45/25, B:2-45/25"],["DB RDL",4,8,45]],["Circuit – 4 rds",["Leg Curl",4,8,null,"A:45/25, B:2-45/25"],["Goblet Squat",4,8,50,"A:35"]]]),
  mk("2025-06-02","lower","Lower Body","3 min bike, banded side steps, banded monster",[["BB Back Squat",["Back Squat",1,10,165],["Back Squat",4,8,185,"A: 65→75"]],["Glute Activation – 3 rds",["Banded Glute Bridge",3,10,null],["Banded Adductor Pulse",3,15,null]],["Circuit – 4 rds",["Leg Extension",4,10,null,"A:45/25, B:2-45/25"],["DB Split Stance Lunge",4,8,30,"A:15"]],["Conditioning – 3 rds",["Bike",3,10,null,"10 cal"],["KB Swing",3,8,53,"A:26"],["KB Sumo Squat",3,8,70,"A:44"]],["Circuit – 4 rds",["Leg Curl",4,10,null,"A:45/25, B:2-45/25"],["Farmer's Carry",4,3,53,"A:35"]]]),
  ...
  mk("2025-06-13","upper","Upper Body","3 min bike, PVC",[["Circuit – 4 rds",["Curl Bar",4,10,null],["Crush Grip Bench Press",4,10,30,"A:15"],["DB Tricep Extension",4,10,null]],["Circuit – 4 rds",["Push Press",4,10,null],["Gorilla Row",4,8,53,"A:26"],["Plate Front Raise",4,10,null]],["Finisher – 4 rds",["Ski",4,12,null],["KB High Pull",4,8,null],["KB Halo",4,10,null],["KB Side Crunch",4,10,null]]]),
  mk("2025-06-16","lower","Lower Body","3 min bike, banded side steps, banded monster",[["BB Back Squat (Ramping)",["Back Squat",1,8,155],["Back Squat",1,8,175],["Back Squat",1,8,185],["Back Squat",1,8,195],["Back Squat",1,6,205,"A: 5x8 @65 w/ box"]],["Circuit – 4 rds",["Step Up w/ Knee Raise",4,8,25,"A:15"],["Calf Raise",4,10,53,"A:26"]],["Circuit – 4 rds",["Leg Extension",4,8,null,"A:45/25, B:2-45/25"],["DB RDL",4,8,45,"A:20"]],["Circuit – 4 rds",["Leg Curl",4,8,null,"A:45/25, B:2-45/25"],["Lunge Step Back",4,8,null]],["Finisher – 4 rds",["Bike Legs Only",4,1,null],["Bike Both",4,1,null],["Sumo Squat Pulse",4,10,null]]]),
  mk("2025-06-24","lower","Lower Body","3 min bike, band warm up",[["Trap Bar DL – 5 rds",["Trap Bar Deadlift",5,8,205,"A: 75"]],["Circuit – 4 rds",["Sled Push",4,1,null,"A:1-2 plate, B:4 plates"],["Calf Raise",4,10,53,"A:35"]],["Circuit – 4 rds",["Landmine Hack Squat",4,8,25,"A:10"],["DB RDL",4,8,45,"A:20"]],["Core – 4 rds",["Reverse Crunch",4,10,null],["Heel Taps",4,20,null]]]),
  mk("2025-06-30","lower","Lower Body","3 min bike, band warm up",[["BB Back Squat",["Back Squat",1,10,165],["Back Squat",2,8,185],["Back Squat",2,6,195,"A: 5x8 @65 w/ box"]],["Core – 3 rds",["Banded Glute Bridge",3,10,null],["Banded Adductor Pulse",3,15,null]],["Circuit – 4 rds",["Leg Extension",4,10,null,"A:45/25, B:2-45+25"],["DB Split Stance Lunge",4,10,30,"A:15"]],["Conditioning – 4 rds",["Row",4,1,null,"200m"],["KB Swing",4,8,53,"A:26"],["KB Sumo Squat",4,8,70,"A:44"]],["Circuit – 4 rds",["Leg Curl",4,10,null,"A:45/25, B:2-45+25"],["Farmer's Carry",4,3,70,"A:44"]]]),
  mk("2025-07-07","lower","Lower Body","3 min bike, banded side steps, banded monster",[["BB Back Squat (Ramping)",["Back Squat",1,8,175],["Back Squat",1,6,185],["Back Squat",1,6,195],["Back Squat",1,5,205],["Back Squat",1,5,215,"A: 5x8 @65 w/ box"]],["Circuit – 4 rds",["Step Down",4,8,25,"A:15"],["Calf Raise",4,10,53,"A:26"]],["Circuit – 4 rds",["Leg Extension",4,8,null,"A:45/25, B:2-45/25"],["DB RDL",4,8,45,"A:20"]],["Circuit – 4 rds",["Leg Curl",4,8,null,"A:45/25, B:2-45/25"],["Lunge Step Back",4,8,null]],["Finisher – 4 rds",["Bike Legs Only",4,1,null],["Bike Both",4,1,null],["Sumo Squat Pulse",4,10,null]]]),
  mk("2025-07-14","lower","Lower Body","3 min bike, banded side steps, banded monster",[["BB Back Squat (Ramping)",["Back Squat",1,8,175],["Back Squat",1,6,185],["Back Squat",1,6,195],["Back Squat",1,5,205],["Back Squat",1,5,215,"A: 5x8 @65 w/ box"]],["Circuit – 4 rds",["Leg Curl",4,8,null,"A:45/35, B:2-45/35"],["Calf Raise",4,15,53,"A:35"]],["Circuit – 4 rds",["Sled Drag",4,1,null,"A:2-3 plate, B:5-6 plates"]],["Circuit – 4 rds",["Sumo Squat",4,10,null],["DB S/L RDL",4,8,45,"A:20"]],["Finisher – 3 rds",["Row",3,1,null,"250m"],["Beast Hold",3,20,null,"sec"],["Power Beast",3,10,null]]]),
  mk("2025-07-21","upper","Upper Body","3 min bike, PVC",[["Core – 4 rds",["Plate Behind Head Crunch",4,10,null],["Kneeling Halo",4,10,35,"A:15"]],["Circuit – 4 rds",["Bicep Curl",4,10,30,"A:15"],["Lat Pullover",4,10,50,"A:25"],["Band Tricep Pushdown",4,10,null]],["Circuit – 4 rds",["Incline Crush Grip Press",4,10,30,"A:20"],["Cable Machine Row",4,10,null],["Around the World",4,10,15,"A:8-10"]],["Finisher – 4 rds",["Ski",4,12,null],["KB High Pull",4,10,53,"A:26"],["Push Up",4,10,null]]]),
  mk("2025-07-28","upper","Upper Body","3 min bike, PVC",[["Core – 4 rds",["DB S/A Press March",4,20,25,"A:15"],["KB Side Crunch",4,10,53,"A:35"]],["Circuit – 4 rds",["Incline Bicep Curl",4,10,30,"A:15"],["Incline Crush Grip Press",4,10,40,"A:20"],["OH Band Tricep Extension",4,10,null]],["Circuit – 4 rds",["Barbell Bent Over Row",4,8,95,"A:65"],["Leaning Lateral Raise",4,10,15,"A:8-10"]],["Finisher – 4 rds",["Row",4,1,null,"300m"],["KB Curl to Press",4,10,53,"A:26"],["Push Up",4,10,null]]]),
  mk("2025-08-05","upper","Upper Body","3 min bike, PVC",[["Bench Press (Ramping)",["Barbell Bench Press",1,8,115],["Barbell Bench Press",1,8,135],["Barbell Bench Press",1,6,155],["Barbell Bench Press",1,6,165,"A: 2x8 bar, 2x8 50-55"]],["Core – 3 rds",["Weighted Dead Bug w/ Lat Pullover",3,10,20,"A:15"],["Russian Twist",3,20,null]],["Circuit – 4 rds",["Push Up",4,10,null],["Bicep Curl",4,10,30,"A:15"],["Bench Dip",4,10,null]],["Finisher – 3 rds",["Row",3,1,null,"200m"],["KB Gorilla Row",3,10,70,"A:26"],["Plate Raise",3,10,25,"A:10"]]]),
  mk("2025-08-11","upper","Full Upper","3 min bike, PVC",[["Circuit – 4 rds",["Zottman Curl",4,10,null],["Incline Push Up",4,10,null],["Cable Tricep Extension",4,12,null]],["Core – 4 rds",["Plate Halo",4,10,null],["KB Side Crunch",4,10,null]],["Circuit – 4 rds",["Cable Row",4,10,null],["Lateral Raise",4,10,null],["DB Bent Over Fly",4,10,null]],["Finisher – 4 rds",["Ski",4,12,null],["KB High Pull",4,10,null],["KB Bicep Curl",4,10,null]]]),
  mk("2025-08-19","upper","Upper Body","3 min bike, PVC",[["Core",["KB Plank Pull Through",1,16,35],["Plank to Shin Taps",1,10,null]],["Circuit – 4 rds",["Bicep Curl",4,15,25,"A:12"],["Dead Hang",4,30,null,"sec"],["S/A Cable Diagonal Tricep",4,10,40,"A:20"]],["Circuit – 4 rds",["Push Press",4,10,20],["Around the World",4,10,10],["DB Server",4,10,12]],["Finisher – 4 rds",["Ski",4,10,null],["Gorilla Row",4,8,35],["Push Up",4,10,null]]]),
  mk("2025-09-02","upper","Upper Body","3 min bike, PVC",[["Core – 4 rds",["Plate Behind Head Crunch",4,10,null],["Heel Taps",4,20,null]],["Circuit – 4 rds",["Bicep Curl",4,10,35,"A:12"],["Lat Pullover",4,10,50,"A:25"],["Band Tricep Pushdown",4,10,null]],["Circuit – 4 rds",["Crush Grip Press",4,10,30,"A:20"],["Chest Fly",4,10,25,"A:15"],["Around the World",4,10,15,"A:8-10"]],["Finisher – 4 rds",["Ski",4,12,null],["KB Clean to Press",4,8,44,"A:26"],["Gorilla Row",4,10,70,"A:26"]]]),
  mk("2025-09-08","upper","Full Upper","3 min bike, PVC",[["Core – 3 rds",["Banded Glute Bridge",3,10,null],["Banded Adductors",3,20,null]],["Circuit – 4 rds",["Concentrated Curl",4,8,15],["Seated Push Press",4,10,10],["Plate Raise w/ Horizontal Press",4,8,10]],["Circuit – 4 rds",["Lat Pullover",4,10,25],["Gorilla Row",4,8,35],["S/A Banded Tricep Pushback",4,10,null]],["Finisher",["Bike Arms Only",4,1,null],["Bike Both",4,1,null]]]),
  mk("2025-09-15","upper","Upper Body","3 min bike, PVC",[["Core – 4 rds",["DB S/A Press March",4,20,25,"A:15"],["KB Side Crunch",4,10,53,"A:35"]],["Circuit – 4 rds",["Bicep Curl Bar",4,10,null,"A:5/2.5, B:25"],["Push Up",4,10,null],["Bench Dip",4,10,null]],["Circuit – 4 rds",["Barbell Bent Over Row",4,8,95,"A:65"],["Around the World",4,10,20,"A:10"]],["Finisher – 4 rds",["Ski",4,10,null,"10/12/14 cal"],["KB Curl",4,8,53,"A:26"],["KB High Pull",4,8,null]]]),
  mk("2025-09-22","upper","Upper Body","Row 3 min, PVC",[["Circuit – 4 rds",["Seated Shoulder Press",4,8,40,"A:15"],["Seated 90° Lateral Raise",4,10,20,"A:8"],["S/A Row",4,10,40,"A:30"]],["Circuit – 4 rds",["Incline Hammer Curl",4,8,15],["Cable Lat Pull Down",4,10,50],["Banded Tricep Pushdown",4,10,null]],["Core",["Cable Ab Twist Hold",1,10,null],["S/A DB Press March",1,20,null]],["Finisher – 4 rds",["Row",4,1,null,"200m"],["KB High Pull",4,10,18],["Push Up",4,10,null]]]),
  mk("2025-10-06","upper","Full Upper","3 min bike, PVC",[["Circuit – 4 rds",["7-7-7 Curl",4,21,20,"A:10"],["Push Up",4,10,null,"A:incline"],["Bench Dip or Cable Extension",4,10,null]],["Core – 4 rds",["Plate Halo",4,10,null],["KB Side Crunch",4,10,null]],["Circuit – 4 rds",["S/A Row",4,8,45,"A:25"],["Front Raise Thumbs Up",4,10,25,"A:8"],["DB Bent Over Fly",4,10,25,"A:10"]],["Finisher – 4 rds",["Ski",4,12,null],["KB High Pull",4,10,null],["KB Bicep Curl",4,10,null]]]),
  mk("2025-10-13","upper","Upper Body","3 min bike, PVC",[["Circuit – 4 rds",["Bicep Curl",4,10,35,"A:12"],["Lat Pullover",4,10,50,"A:25"],["Bench Dip",4,10,null]],["Core – 4 rds",["Plate Behind Head Crunch",4,10,null],["Russian Twist",4,20,null]],["Circuit – 4 rds",["Incline Crush Grip Press",4,10,35,"A:20"],["Gorilla Row",4,10,70,"A:26"],["Around the World",4,10,15,"A:8-10"]],["Finisher – 4 rds",["Row",4,1,null,"200m"],["Med Ball Slams",4,10,null]]]),
  mk("2025-10-20","upper","Upper Body","Row 3 min, PVC",[["Circuit – 4 rds",["Seated Shoulder Press",4,8,40,"A:12-15"],["S/A Cable Lat Pulldown",4,10,null],["S/A Row",4,10,40,"A:30"],["Plank Shoulder Taps",4,16,null]],["Circuit – 4 rds",["Incline Hammer Curl",4,8,30,"A:15"],["Plate Front Raise",4,10,35,"A:15"],["Banded S/A Tricep Kickback",4,10,null]],["Core",["S/A DB Press Walk",1,1,null,"A:12-15, B:25-30"],["KB Side Crunch",1,10,53,"A:35"]],["Finisher – 4 rds",["Row",4,1,null,"200m"],["KB High Pull",4,10,53,"A:26"]]]),
  mk("2025-10-27","upper","Upper Body","3 min bike, PVC",[["Bench Press (Ramping)",["Barbell Bench Press",1,8,135],["Barbell Bench Press",1,8,155],["Barbell Bench Press",1,6,175],["Barbell Bench Press",1,6,195,"A: 2x8 @25bar, 2x6 @25bar+5s"]],["Core – 3 rds",["Weighted Dead Bug w/ Lat Pullover",3,10,20,"A:15"],["Russian Twist",3,20,null]],["Circuit – 4 rds",["Bicep Curl",4,10,30,"A:15"],["Around the World",4,10,25,"A:10"],["Bench Dip",4,10,null]],["Finisher – 3 rds",["Row",3,1,null,"200m"],["KB Gorilla Row",3,10,70,"A:35"],["Plate Raise Horizontal Press",3,10,25,"A:10"]]]),
  mk("2025-11-03","upper","Full Upper","3 min bike, PVC",[["Circuit – 4 rds",["Zottman Curl",4,10,null],["Push Up",4,10,null],["Cable Tricep Extension",4,12,null],["Farmer's Carry",4,2,null,"A:35/53, B:53/70"]],["Core – 4 rds",["Plate Halo",4,10,null],["Cable Crunch Hold",4,10,null]],["Circuit – 4 rds",["Gorilla Row",4,10,null],["Lateral Raise",4,10,null],["DB Chest Fly",4,10,null]],["Finisher – 4 rds",["Ski",4,12,null],["KB High Pull",4,10,null],["KB Bicep Curl",4,10,null]]]),
  mk("2025-12-01","upper","Upper Body","3 min bike, PVC",[["Core – 4 rds",["Plate Behind Head Crunch",4,10,null],["Heel Taps",4,20,null]],["Circuit – 4 rds",["Bicep Curl",4,10,35,"A:12"],["Lat Pullover",4,10,50,"A:25"],["Band Tricep Pushdown",4,10,null]],["Circuit – 4 rds",["Crush Grip Press",4,10,30,"A:20"],["Chest Fly",4,10,25,"A:15"],["Around the World",4,10,15,"A:8-10"]],["Finisher – 4 rds",["Ski",4,12,null],["KB Clean to Press",4,8,44,"A:26"],["Gorilla Row",4,10,70,"A:26"]]]),
  mk("2025-12-08","upper","Full Upper","3 min bike, PVC",[["Circuit – 4 rds",["7-7-7 Curl",4,21,20,"A:10"],["Push Up",4,10,null,"A:incline"],["Bench Dip or Cable Extension",4,10,null]],["Core – 4 rds",["Plate Halo",4,10,null],["KB Side Crunch",4,10,null]],["Circuit – 4 rds",["S/A Row",4,8,45,"A:25"],["Front Raise Thumbs Up",4,10,25,"A:8"],["DB Bent Over Fly",4,10,25,"A:10"]],["Finisher – 4 rds",["Ski",4,12,null],["KB High Pull",4,10,null],["KB Bicep Curl",4,10,null]]]),
  mk("2025-12-15","upper","Upper Body","3 min bike, PVC",[["Circuit – 4 rds",["Bicep Curl",4,10,25,"A:12"],["Dead Hang",4,30,null,"sec"],["S/A Cable Diagonal Tricep",4,10,40,"A:20"]],["Core",["KB Plank Pull Through",1,16,null,"A:26, B:44"],["Plank to Shin Taps",1,10,null]],["Circuit – 4 rds",["Push Press",4,10,20],["Around the World",4,10,10],["Cable Row",4,10,60,"A:40"]]]),
  mk("2025-12-22","upper","Upper Body","3 min bike, PVC",[["Core – 4 rds",["DB S/A Press March",4,20,25,"A:15"],["KB Side Crunch",4,10,53,"A:35"]],["Circuit – 4 rds",["Bicep Curl Bar",4,10,null,"A:35bar, B:10/2.5"],["Push Up",4,10,null],["Bench Dip",4,10,null]],["Circuit – 4 rds",["Barbell Bent Over Row",4,8,null,"A:10s, B:45s"],["Lean Lateral Raise",4,10,25,"A:8"]],["Finisher – 4 rds",["Ski",4,12,null],["KB Clean & Press",4,10,53,"A:26"]]]),
  mk("2025-12-29","upper","Upper Body","Row 3 min, PVC",[["Circuit – 4 rds",["Seated Shoulder Press",4,8,40,"A:12-15"],["Seated 90° Lateral Raise",4,10,20,"A:8"],["S/A Row",4,10,45,"A:30"]],["Circuit – 4 rds",["Incline Hammer Curl",4,8,15],["Cable Lat Pull Down",4,10,50],["Banded Tricep Pushdown",4,10,null]],["Core",["Cable Ab Crunch Hold",1,10,null],["Banded Hold Leg Raise",1,10,null]],["Finisher – 4 rds",["Bike",4,1,null,"1.5 min"],["Med Ball Slam",4,10,null]]]),
  mk("2026-01-05","upper","Full Upper","3 min bike, PVC",[["Circuit – 4 rds",["7-7-7 Curl",4,21,20,"A:10"],["Push Up",4,10,null,"A:incline"],["Bench Dip or S/A Tricep Extension",4,10,null]],["Core – 4 rds",["Plate Halo Hip to Hip",4,10,null],["KB Side Crunch",4,10,null]],["Circuit – 4 rds",["S/A Row",4,8,45,"A:25"],["Plate Front Raise",4,10,45,"A:15"],["Banded Face Pull",4,10,null]],["Finisher – 4 rds",["Bike Arms Only",4,1,null],["Bike Both",4,1,null]]]),
  mk("2026-01-12","upper","Full Upper","3 min bike, PVC",[["Circuit – 4 rds",["Concentrated Curl",4,8,35,"A:15"],["Seated Around the World",4,10,20,"A:8"],["Plate Raise w/ Horizontal Press",4,10,35,"A:15"]],["Core – 3 rds",["Banded Glute Lat Overhead",3,10,35,"A:18"],["Banded Glute Bridge",3,10,null],["Banded Adductors",3,20,null]],["Circuit – 4 rds",["Gorilla Row",4,8,70,"A:35"],["Farmer's Carry",4,2,70,"A:35"],["S/A Banded Tricep Extension",4,10,null]],["Finisher",["Bike Arms Only",4,1,null],["Bike Both",4,1,null]]]),
  mk("2026-02-09","upper","Full Upper","3 min bike, PVC",[["Circuit – 4 rds",["Zottman Curl",4,10,35,"A:12"],["Push Up",4,10,null],["Cable Tricep Extension",4,12,null]],["Core – 4 rds",["Plate Halo",4,10,35,"A:15"],["KB Side Crunch",4,10,53,"A:35"]],["Circuit – 4 rds",["Cable Row",4,10,60,"A:30"],["Lateral Raise",4,10,25,"A:10"],["DB Seated Bent Over Fly",4,10,45,"A:12"]],["Finisher – 4 rds",["Bike Arms Only",4,30,null,"sec"],["KB High Pull",4,10,53,"A:26"],["KB Bicep Curl",4,10,53,"A:26"]]]),
  mk("2026-02-16","upper","Upper Body","Row 3 min, PVC",[["Circuit – 4 rds",["Seated Shoulder Press",4,8,40,"A:15"],["Seated 90° Lateral Raise",4,10,20,"A:8"],["S/A Row",4,10,40,"A:30"]],["Circuit – 4 rds",["Incline Hammer Curl",4,8,15],["Cable Lat Pull Down",4,10,50],["Banded Tricep Pushdown",4,10,null]],["Core",["Cable Ab Twist Hold",1,10,null],["S/A DB Press March",1,20,null]],["Finisher – 4 rds",["Row",4,1,null,"200m"],["KB High Pull",4,10,18],["Push Up",4,10,null]]]),
];

const SEED_CLIENT_BILLY={id:"billy",name:"Billy & Alli",fullName:"Billy & Alli",startDate:"2025-01-13",color:"#E11D48",
  ...
  return <div style={{background:isL?`linear-gradient(135deg,${T.card},${T.green}08)`:isP?`linear-gradient(135deg,${T.card},${T.accent}06)`:editing?`linear-gradient(135deg,${T.card},${T.blue}06)`:T.card,border:`1px solid ${isL?T.green+"40":isP?T.accent+"30":editing?T.blue+"40":T.border}`,borderRadius:"10px",overflow:"hidden",marginBottom:"8px"}}>
    ...
    {open&&<div style={{borderTop:`1px solid ${T.border}`}}>
      ...
      {isC&&!editing&&open&&<div style={{padding:"8px 14px",borderTop:`1px solid ${T.border}`,display:"flex",justifyContent:"flex-end",gap:"8px"}}>
        ...
        {onEdit&&<button onClick={onEdit} style={{background:"none",border:"none",color:T.blue,fontSize:"11px",cursor:"pointer",fontFamily:"inherit",fontWeight:600}}>✏️ Edit</button>}
...
function WorkoutBuilder({type,types,onTypeChange,allWs,onSave,onCancel}){
  ...
  return <div style={{...ss.card,border:`1px solid ${T.cyan}40`,marginBottom:"12px"}}>
    ...
    {blocks.map((bl,bi)=><div key={bi} style={{border:`1px solid ${T.border}`,borderRadius:"7px",padding:"8px",marginBottom:"8px",background:T.surface}}>
      ...
      <button onClick={()=>addEx(bi)} style={{background:"none",border:`1px dashed ${T.border}`,color:T.dim,padding:"4px",borderRadius:"5px",width:"100%",fontSize:"11px",cursor:"pointer",fontFamily:"inherit"}}>+ Exercise</button>
    </div>)}
    ...
    <div style={ss.content}>
      ...
      {tab==="overview"&&<>
        ...
        {sorted.length>0&&<div style={{...ss.card,padding:"12px 14px",marginBottom:"10px"}}>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"8px"}}><span style={{color:T.sub,fontSize:"11px",fontWeight:700,letterSpacing:"1px"}}>📈 CONSISTENCY</span>{cs.streak>=2&&<span style={{...ss.mono,background:T.green+"15",color:T.green,padding:"2px 8px",borderRadius:"5px",fontSize:"11px",fontWeight:700}}>🔥 {cs.streak} week streak</span>}</div>
        ...
        {(()=>{const hasRd=readiness.sleep||readiness.soreness||readiness.energy;const rc=(f,v)=>setReadiness(p=>({...p,[f]:p[f]===v?null:v}));
          ...
          return <div style={{...ss.card,border:`1px solid ${hasRd?T.purple+"40":T.border}`,marginBottom:"10px"}}>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:exp.readiness?"10px":"0",cursor:"pointer"}} onClick={()=>tog("readiness")}>
              <div style={{display:"flex",alignItems:"center",gap:"6px"}}>
                <span style={{color:T.purple,fontSize:"11px",fontWeight:700,letterSpacing:"1px"}}>📋 TODAY'S CHECK-IN</span>
